<?php
/**
 * pixcell_medical functions and definitions
 *
...
if ( ! function_exists( 'pixcell_medicalpixcell_medicaletup' ) ) :
	...
	function pixcell_medicalpixcell_medicaletup() {
		 ...
		 * If you're building a theme based on pixcell_medical, use a find and replace
		 * to change 'pixcell_medical' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'pixcell_medical' ),
			)
		);
...
function pixcell_medical_widgets_init() {
	registerpixcell_medicalidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'pixcell_medical' ),
...
add_action( 'widgets_init', 'pixcell_medical_widgets_init' );
