	...
	<main id="primary" class="site-main check">
		...
		<section class="error-404 not-found">
			<header class="page-header">
				<h1 class="page-title"><?php esc_html_e( 'Oops! That page can&rsquo;t be found.', 'pixcell_medical' ); ?></h1>
			</header><!-- .page-header -->
			...
			<div class="page-content">
				<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'pixcell_medical' ); ?></p>
					...
					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'pixcell_medical' ); ?></h2>
						<ul>
							<?php
							wp_list_categories(
								array(
